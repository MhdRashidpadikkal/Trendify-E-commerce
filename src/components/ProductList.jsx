            ...
            {data.map((item, index) => (
                <div 
                    ...
                    <div className='flex flex-col items-start relative'>
                        ...
                        <button 
                            className={`borde px-4 rounded-md font-semibold w-full mt-3 cursor-pointer py-1 sm:text-[18px] text-nowrap border ${state.cartItems.some(cart => cart === item.id ) ? 'bg-[#229422] text-gray-300 ' : 'border-black' }  `}
